...
/* ---------- DNN Thread ---------- */
APITYPE Laser   *   createMasterLaserDNN( char *a_amFn, char *a_dnnFn, float a_priW, char *a_priFn, char *a_normFn, int a_miniBatch,
                                            int a_useGPU, int a_idGPU, char *a_latFn, char *a_symFn );
APITYPE void        freeMasterLaserDNN( Laser *a_recP );
APITYPE Laser *     createChildLaserDNN( Laser *, char *a_amFn, char *a_dnnFn, float a_priW, char *a_priFn, char *a_normFn, int a_miniBatch,
                                            int a_useGPU, int a_idGPU, char *a_latFn, char *a_symFn );
APITYPE void        freeChildLaserDNN( Laser *a_recP );

/* ---------- ESDL interface ---------- */
APITYPE Laser   *   createMasterLaserDLNet( char *a_amFn, char *a_dnnFn, float a_priW, char *a_priFn, char *a_normFn, int a_miniBatch,
		                                                                                        int a_useGPU, int a_idGPU, char *a_latFn, char *a_symFn );
APITYPE void        freeMasterLaserDLNet( Laser *a_recP );
APITYPE Laser *     createChildLaserDLNet( Laser *, char *a_amFn, char *a_dnnFn, float a_priW, char *a_priFn, char *a_normFn, int a_miniBatch,
		                                                                                        int a_useGPU, int a_idGPU, char *a_latFn, char *a_symFn );
APITYPE void        freeChildLaserDLNet( Laser *a_recP );

APITYPE int			getDLNetNumInNodeLASER( Laser *a_recP );
APITYPE int			getDLNetNumOutNodeLASER( Laser *a_recP );
APITYPE int			getDLNetKindLASER( Laser *a_recP );
